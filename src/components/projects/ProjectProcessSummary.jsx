...
const STEPS = [
  { number: 1, title: 'Review Drawings', icon: Send },
  { number: 2, title: 'Confirm Requirements', icon: FileSearch },
  { number: 3, title: 'Plan Machining Approach', icon: ClipboardList },
  { number: 4, title: 'Machine and Inspect', icon: Cog },
  { number: 5, title: 'Deliver with Confidence', icon: PackageCheck },
];

export default function ProjectProcessSummary() {
  return (
    <section className="section-padding bg-brand-light" aria-labelledby="project-process-heading">
      <div className="section-container">
        <h2 id="project-process-heading" className="text-center text-3xl font-bold tracking-tight text-charcoal sm:text-4xl">
